...
# PATHS
########
data_path = 'E:/ixarea/dataset/128'  # set path to training set images
output_path = '../../LittleGAN-test/fid_stats_celeba_128_all.npz'  # path for where to store the statistics
